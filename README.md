...
**Prerequisites:** [Go 1.26.5 or newer](https://go.dev/dl/), [Claude Code](https://claude.ai/code), and Node/npm for `npx`. The skills are tested with Claude Code; other harnesses like Codex may work but aren't tested. **Use Claude Code for the best experience.**
...
- **Requires Go 1.26.5 or newer and Claude Code.** No standalone distribution today; the slash command is the supported entry point.
